...
import by.goncharov.task05.service.creators.ThreadsWithCountDownLatchCreator;
import by.goncharov.task05.view.Locale;
import java.io.IOException;
import java.util.List;
import java.util.concurrent.TimeUnit;

public class ThreadWithCountDownLatchCommand implements Command{
    @Override
    public String execute(List<String> list) throws InterruptedException, IOException, DAOException {
        ...
        StringBuilder result = new StringBuilder().append(Locale.
                getInstance().getResourceBundle().getString("THIRD")).append(
